...
export const singUpFx = createEffect(async ({ email, password, url, username }: ISignUpFx) => {
...
export const singInFx = createEffect(async ({ password, url, username }: ISignInFx) => {
