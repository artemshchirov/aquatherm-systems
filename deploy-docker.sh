...
export APP=${1}
# export DOCKER_NAME=ghcr.io/artemshchirov/ecommerce-template-api
...
# docker run -p 8080:80 -e DOPPLER_TOKEN=$DOPPLER_TOKEN -e APP_ENV=prod -e PORT=80 $DOCKER_NAME:$TAG
