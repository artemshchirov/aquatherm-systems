    ...
    <section>
      <div className="container">
        <div className={`${styles.product__top} ${darkModeClass}`}>
          <h2 className={`${styles.product__title} ${darkModeClass}`}>
            {product.name}
          </h2>
          <div className={styles.product__inner}>
            ...
            <div className={styles.product__info}>
              <span
                className={`${styles.product__info__price} ${darkModeClass}`}
              >
                {formatPrice(product.price || 0)} ₪
              </span>
              <span className={styles.product__info__stock}>
                {product.in_stock > 0 ? (
                  <span className={styles.product__info__stock__success}>
                    In stock
                  </span>
                ) : (
                  <span className={styles.product__info__stock__not}>
                    Not in stock
                  </span>
                )}
              </span>
              <span className={styles.product__info__code}>
                Article: {product.vendor_code}
              </span>
              <button
                className={`${styles.product__info__btn} ${
          ...
          <div className={styles.product__accordion}>
            <div className={styles.product__accordion__inner}>
              <ProductAccordion title="Description">
                <div
                  className={`${styles.product__accordion__content} ${darkModeClass}`}
                >
                  <h3
