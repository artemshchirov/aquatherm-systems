...
const CatalogFilters = ({
  ...
  const applyFiltersFromQuery = async () => {
    try {
      ...
      const vendorQuery = `&vendor=${getQueryParamOnFirstRender(
        'vendor',
        firstParams,
        pathname
      )}`
  ...
  const applyFilters = async () => {
    ...
    try {
      ...
      const encodedVendorQuery = encodeURIComponent(
        JSON.stringify(checkedVendors)
      )
